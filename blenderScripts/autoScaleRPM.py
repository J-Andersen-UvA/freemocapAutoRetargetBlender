...
source_left_shoulder_bone_name = "shoulder.R"

source_shoulder_height = get_shoulder_height(source_armature_name, source_left_shoulder_bone_name, source_left_shoulder_bone_name)
